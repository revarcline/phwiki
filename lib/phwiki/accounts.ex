defmodule Phwiki.Accounts do
  ...
  alias Phwiki.Repo
  alias Phwiki.Accounts.{User, UserToken, UserNotifier}
  ...
  ## Examples
      ...
      iex> update_user_username(user, %{username: "Valid username"})
      {:ok, %User{}}

      iex> update_user_password(user, %{username: "Invalid username"})
      {:error, %Ecto.Changeset{}}
